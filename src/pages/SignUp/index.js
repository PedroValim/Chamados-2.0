...
export default function SignIU() {
            ...
            <div className="login">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <input type="text"
                        ...
                        value={name}
                        onChange={(e) => setName(e.target.value)}  //capta o que esta sendo digitado e passa para a useState, o valor fica armazenado em setName
                    />
